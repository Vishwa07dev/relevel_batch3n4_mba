...
module.exports = (app) =>{
    ...
    app.post('/mba/api/v1/payments/:id',[authJwt.verifyToken, validateIdInParams.bookingInParams, validatePayment.validatePaymentStatus], PaymentService.createPayment);
