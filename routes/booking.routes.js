...
module.exports = (app)=>{
    ...
    app.put("/mba/api/v1/booking/:id", [authJwt.verifyToken, validateIdInParams.bookingInParams], bookingController.updateBooking);

    app.get("/mba/api/v1/booking/:id",[authJwt.verifyToken, validateIdInParams.bookingInParams, authJwt.isTheatreOwnerOrAdmin], bookingController.findOneBooking);
