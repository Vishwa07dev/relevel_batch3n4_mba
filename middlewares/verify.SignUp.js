 ...
 */
 ...
 const validateSignUpRequestBody = async (req, res, next) => {
     ...
     const userTypes = [constants.userTypes.customer,constants.userTypes.thearte_owner]
     if(!userTypes.includes(req.body.userType)){
         return res.status(400).send({
             message : "UserType provided is not correct. Possible correct values : CUSTOMER | THEARTE_OWNER"
         })
     }
